resource "oci_core_instance" "my_vm" {
  ...
  availability_domain = "CtIH:ap-dcc-gazipur-1-ad-1"  # Update with the correct Availability Domain (AD)
  shape               = "VM.Standard2.1"  # Example VM shape (you can change it based on your needs)
  ...
  # Use the image ID you found in the Oracle Cloud UI
  source_details {
    source_type = "image"  # Specifying that the source for the instance is an image
